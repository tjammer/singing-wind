...
{
public:
  WLeafBuilder(parent_type& parent,
               std::shared_ptr<behaviour_type> leaf_behaviour)
    : m_parent(parent)
    , m_leaf_behaviour(leaf_behaviour)
  {
  }

  parent_type& end(void) { return m_parent; }

private:
  parent_type& m_parent;
  std::shared_ptr<behaviour_type> m_leaf_behaviour;
};
...
public:
  ...
  {
    auto node =
      std::make_shared<node_type>(std::forward<param_types>(params)...);
  ...
  WCompositeBuilder<WCompositeBuilder, other_composite_type> composite(
    param_types&&... params)
  {
    auto node = std::make_shared<other_composite_type>(
      std::forward<param_types>(params)...);
    m_composite->add_child(node);
    return WCompositeBuilder<WCompositeBuilder, other_composite_type>(*this,
                                                                      node);
  }

  template<class decorator_type, typename... param_types>
  WDecoratorBuilder<WCompositeBuilder, decorator_type> decorator(
    param_types&&... params)
  {
    auto node =
      std::make_shared<decorator_type>(std::forward<param_types>(params)...);
    m_composite->add_child(node);
...
public:
  ...
  WCompositeBuilder<WDecoratorBuilder, composite_type> composite(
    param_types&&... params)
  {
    auto node =
      std::make_shared<composite_type>(std::forward<param_types>(params)...);
    m_decorator->set_child(node);
  ...
  WDecoratorBuilder<WDecoratorBuilder, other_decorator_type> decorator(
    param_types&&... params)
  {
    auto node = std::make_shared<other_decorator_type>(
      std::forward<param_types>(params)...);
    m_decorator->set_child(node);
    return WDecoratorBuilder<WDecoratorBuilder, other_decorator_type>(*this,
                                                                      node);
  }
...
public:
  ...
  template<class composite_type, typename... param_types>
  WCompositeBuilder<WBehaviourTreeBuilder, composite_type> composite(
    param_types&&... params)
  {
    auto node =
      std::make_shared<composite_type>(std::forward<param_types>(params)...);
    m_root->add_child(node);
    return WCompositeBuilder<WBehaviourTreeBuilder, composite_type>(*this,
                                                                    node);
  }

  template<class decorator_type, typename... param_types>
  WDecoratorBuilder<WBehaviourTreeBuilder, decorator_type> decorator(
    param_types&&... params)
  {
    auto node =
      std::make_shared<decorator_type>(std::forward<param_types>(params)...);
    m_root->add_child(node);
    return WDecoratorBuilder<WBehaviourTreeBuilder, decorator_type>(*this,
                                                                    node);
  }

  selector_type end(void) { return *m_root; }
