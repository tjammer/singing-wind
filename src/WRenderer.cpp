...
void ::WRenderer::init(GLFWwindow *window) {
    ...
    glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, sizeof(PrimitiveVertex), (GLvoid *) 0);
    glEnableVertexAttribArray(0);
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(PrimitiveVertex), (GLvoid *) (2 * sizeof(GLfloat)));
...
void WRenderer::render_array() {
    GLint transformLoc = glGetUniformLocation(primitive_shader.get_program(), "transform");
    glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(camera_transform));
