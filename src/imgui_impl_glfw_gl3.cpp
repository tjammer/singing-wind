...
void
ImGui_ImplGlfwGL3_MouseButtonCallback(GLFWwindow* window,
                                      int button,
                                      int action,
                                      int mods)
{
...
void
ImGui_ImplGlfwGL3_KeyCallback(GLFWwindow* window,
                              int key,
                              int scancode,
                              int action,
                              int mods)
...
ImGui_ImplGlfwGL3_CreateFontsTexture()
{
  ...
  io.Fonts->GetTexDataAsRGBA32(
    &pixels, &width, &height); // Load as RGBA 32-bits (75% of the memory is
                               // wasted, but default font is so small) because
                               // it is more likely to be compatible with user's
                               // existing shaders. If your ImTextureId
                               // represent a higher-level concept than just a
                               // GL texture id, consider calling
