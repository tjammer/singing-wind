...
WShader::WShader(const std::string &vertex_file, const std::string &fragment_file) {
    ...
    vertex_shader_src.assign(std::istreambuf_iterator<char>(vertex_stream), std::istreambuf_iterator<char>());
    ...
    fragment_shader_src.assign(std::istreambuf_iterator<char>(fragment_stream), std::istreambuf_iterator<char>());
